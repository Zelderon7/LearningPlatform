...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20250301191925_fixed_fk_on_user_task")]
    partial class fixed_fk_on_user_task
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.CodingFiles.CodingTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.CodingFiles.TaskSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.CodingFiles.TaskSubmission", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Entities.CodingFiles.CodingFolder", "Folder")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Models.Entities.CodingFiles.TaskSubmission", "FolderId")
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.JoinInstitutionRequest", b =>
                {
                    b.HasOne("WebApplication1.Models.Entities.Institution", "Institution")
                        .WithMany("JoinInstitutionRequests")
                        .HasForeignKey("InstitutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication1.Models.Entities.Institution", b =>
                {
                    ...
                    b.Navigation("JoinInstitutionRequests");
